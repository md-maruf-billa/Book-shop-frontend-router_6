                  ...
                  <div className="border w-[400px] p-8 rounded-lg  backdrop-blur-md bg-brandPrimary/40">
                        ...
                        <form >
                              ...
                              <div className="mt-8">
                                    ...
                                    <input placeholder="Ex: mahid@example.com" type="email" id="email" className="w-full border border-brandTextSecondary p-2 rounded-lg bg-transparent outline-none mt-2 placeholder:text-gray-500" />
                              </div>

                              <div className="mt-4">
                                    <label htmlFor="password" className="font-semibold tracking-[4px] text-brandTextTertiary">PASSWORD</label>
                                    <input placeholder="Ex: ********" type="password" id="password" className="w-full border border-brandTextSecondary p-2 rounded-lg bg-transparent outline-none mt-2 placeholder:text-gray-500" />
                              </div>
